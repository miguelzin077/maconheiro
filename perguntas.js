export const perguntas = [
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "alunos usando IA para colar em provas",
        ...
        alternativas: [
            {
                ...
                afirmacao: [
                    "utilizei IA para responder todas as perguntas",
        ...
        alternativas: [
            {
                texto: "Utiliza uma ferramenta de busca na internet que utiliza IA para que ela ajude a encontrar informações relevantes para o trabalho e explique numa linguagem que facilite o entendimento.",
                afirmacao: [
                    "utilizo para me dizer inormçôes uteis do dia a dia",
                    "Percebeu que a IA pode ajudar a encontrar informações úteis na internet de forma mais rápida e direcionada.",
                    "Percebeu que a IA consegue explicar termos complicados de forma simplificada e isso ajudou muito suas pesquisas sobre assuntos complexos."
                ],
                proxima: 3,
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "eu colocaria que a IA pode ser muito util no nosso dia dia e tambem facilitar muitas atividades no nosso dia",
                afirmacao: [
            ...
            {
                texto: "defendo que a IA nao deve ser usadas em todos os momentos, se nao as pessoas vao se tornar mais burra do que ja sao.",
                afirmacao: [
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "critica a IA e ugere que as pessoas tem que deixar de ser burras e pensar sozinhas.",
                afirmacao: [
                    "Vem impulsionando a inovação na área de IA e luta para abrir novos caminhos profissionais com IA.",
                    "Participa ativamente do desenvolvimento de soluções criativas e na melhoria de processos em IA."
                ],
        ...
        alternativas: [
            {
                ...
                proxima: 7export const perguntas = [
    {
        enunciado: "Assim que saiu da escola você se depara com uma nova tecnologia, um chat que consegue responder todas as dúvidas que uma pessoa pode ter, ele também gera imagens e áudios hiper-realistas. Qual o primeiro pensamento?",
        alternativas: [
            {
